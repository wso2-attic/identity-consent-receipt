...
public class SQLQueries {
    ...
    public static final String PURPOSE_BY_USER_BY_SERVICE_QUERY = "SELECT A.SGUID,A.SERVICE_ID,B.SERVICE_DESCRIPTION," +
            "A.PURPOSE_ID,A.STATUS\n" +
            "FROM SERVICE_MAP_CRID AS A,SERVICES AS B\n" +
            "WHERE A.SGUID=?\n" +
            "AND A.STATUS=\"Approved\"\n" +
    ...
    public static final String UPDATE_THIRD_PARTY_QUERY = "UPDATE THIRD_PARTY SET THIRD_PARTY_NAME=? WHERE THIRD_PARTY_ID=?;";

    public static final String ADD_THIRD_PARTY_QUERY = "INSERT INTO THIRD_PARTY(THIRD_PARTY_NAME) VALUES (?);";

    public static final String SELECT_LAST_INSERTED_THIRD_PARTY_QUERY = "SELECT last_insert_id() AS id FROM THIRD_PARTY" +
    ...
    public static final String SELECT_LAST_INSERTED_PURPOSE_CAT = "SELECT last_insert_id() AS id FROM PURPOSE_CATEGORY" +
            " ORDER BY id DESC LIMIT 1;";
    ...
    public static final String SELECT_SERVICE_DES_BY_ID = "SELECT SERVICE_DESCRIPTION FROM SERVICES WHERE SERVICE_ID=?;";
    ...
    public static final String SELECT_PURPOSE_DETAILS_BY_ID_QUERY = "SELECT A.*,B.THIRD_PARTY_NAME FROM PURPOSES AS A," +
            "THIRD_PARTY AS B WHERE B" +
            ".THIRD_PARTY_ID=A.THIRD_PARTY_ID AND PURPOSE_ID=?;";

    public static final String SELECT_PURPOSE_NAME_BY_ID = "SELECT PURPOSE FROM PURPOSES WHERE PURPOSE_ID=?;";

    public static final String DELETE_PURPOSE_MAPPINGS_TO_PII_CAT = "DELETE FROM PURPOSE_MAP_PII_CAT WHERE PURPOSE_ID=?;";

    public static final String DELETE_PURPOSE_MAPPINGS_TO_PURPOSE_CAT = "DELETE FROM PURPOSE_MAP_PURPOSE_CAT WHERE PURPOSE_ID=?;";

    public static final String DELETE_PURPOSE_MAPPINGS_TO_SERVICE = "DELETE FROM SERVICE_MAP_PURPOSE WHERE PURPOSE_ID=?;";
    ...
    public static final String ADD_PURPOSE_MAPPING_WITH_PURPOSE_CAT = "INSERT INTO PURPOSE_MAP_PURPOSE_CAT(PURPOSE_ID," +
            "PURPOSE_CAT_ID) VALUES (?,?) ON DUPLICATE KEY UPDATE PURPOSE_CAT_ID=?;";
    ...
    public static final String SELECT_PII_CAT_BY_ID = "SELECT PII_CAT FROM PII_CATEGORY WHERE PII_CAT_ID=?;";
    ...
    public static final String ADD_PII_CATEGORY = "INSERT INTO user_consent.PII_CATEGORY(PII_CAT,PII_CAT_DESCRIPTION," +
            "SENSITIVITY) VALUES(?,?,?);";

    public static final String GET_LAST_INSERTED_PII_CAT_ID = "SELECT last_insert_id() as id FROM PII_CATEGORY LIMIT 1;";
    ...
    public static final String SELECT_DATA_CONTROLLER_BY_ID = "SELECT * FROM DATA_CONTROLLER WHERE DATA_CONTROLLER_ID=?;";

    public static final String GET_PURPOSE_ID = "SELECT PURPOSE_ID FROM user_consent.PURPOSES WHERE PURPOSE=?";

    public static final String GET_SERVICE_ID = "SELECT SERVICE_ID FROM user_consent.SERVICES WHERE SERVICE_DESCRIPTION=?";
    ...
    public static final String GET_PURPOSE_BY_ID = "SELECT A.*,B.THIRD_PARTY_NAME FROM PURPOSES AS A,THIRD_PARTY AS B" +
            " WHERE PURPOSE_ID=? AND A.THIRD_PARTY_ID=B.THIRD_PARTY_ID;";

    public static final String GET_TERMINATION_BY_PURPOSE = "SELECT TERMINATION FROM user_consent.PURPOSES WHERE PURPOSE_ID=?";
